...
const Footer: React.FC = () => {
    return (
        ...
        >
            {/* Background Pattern */}
            <div
                className="absolute inset-0 opacity-5 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]"></div>
            ...
            <div
                className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-white/10 text-center text-gray-500 text-sm relative z-50 space-y-2">
                {/* Main Copyright */}
                <p>
                    &copy; 2026 Innobiz Symposium. All Rights Reserved By{" "}
                    <button
                        type="button"
                        onClick={() =>
                            window.open(
                                "https://www.instagram.com/ft._.thunderjoe._/",
                                "_blank"
                            )
                        }
                        className="text-orange-500 hover:text-orange-400 font-semibold transition-colors no-underline bg-transparent border-0 p-0 cursor-pointer"
                    >
                        Jeevith Thunderjoe.
                    </button>
                </p>
                ...
                <p className="flex flex-wrap justify-center gap-x-2 gap-y-1">
                    ...
                    <button
                        ...
                        onClick={() =>
                            window.open(
                                "https://www.instagram.com/mxddy.ex?igsh=eHRmZ254bXNxdnI0",
                                "_blank"
                            )
                        }
                        className="text-white hover:text-orange-500 font-medium transition-colors no-underline bg-transparent border-0 p-0 cursor-pointer"
                    >
                        Maddy
                    </button>
                    ...
                    <button
                        ...
                        onClick={() =>
                            window.open(
                                "https://www.instagram.com/jagz07x/",
                                "_blank"
                            )
                        }
                        className="text-orange-500 hover:text-gray-300 font-medium transition-colors no-underline bg-transparent border-0 p-0 cursor-pointer"
                    >
                        Jagadeshwaran
                    </button>
                </p>
